...
(N'La Roche-Posay Effaclar Gel', N'Chống nắng', 891122.5, 93, 'https://example.com/images/la_roche-posay_effaclar_gel.jpg', N'Sản phẩm La Roche-Posay Effaclar Gel thuộc danh mục Chống nắng'),
(N'Anessa Perfect UV Sunscreen', N'Dưỡng da', 296505.08, 91, 'https://example.com/images/anessa_perfect_uv_sunscreen.jpg', N'Sản phẩm Anessa Perfect UV Sunscreen thuộc danh mục Dưỡng da, phù hợp với mọi loại da.'),
(N'Some By Mi AHA-BHA-PHA 30 Days Miracle Cream', N'Dưỡng tóc', 440452.81, 84, 'https://example.com/images/some_by_mi_aha-bha-pha_30_days_miracle_cream.jpg', N'Sản phẩm Some By Mi AHA-BHA-PHA 30 Days Miracle Cream thuộc danh mục Dưỡng tóc.'),
(N'Maybelline Fit Me Matte+Poreless Foundation', N'Nước hoa', 744300.43, 31, 'https://example.com/images/maybelline_fit_me_matteplusporeless_foundation.jpg', N'Sản phẩm Maybelline Fit Me Matte+Poreless Foundation thuộc danh mục Nước hoa, phù hợp với mọi loại da.'),
(N'Bioderma Sensibio H2O', N'Tẩy trang', 282356.62, 22, 'https://example.com/images/bioderma_sensibio_h2o.jpg', N'Sản phẩm Bioderma Sensibio H2O thuộc danh mục Tẩy trang, phù hợp với mọi loại da.'),
(N'Moroccanoil Treatment', N'Chống nắng', 674922.39, 62, 'https://example.com/images/moroccanoil_treatment.jpg', N'Sản phẩm Moroccanoil Treatment thuộc danh mục Chống nắng, phù hợp với mọi loại da.'),
(N'Dior Sauvage Eau de Toilette', N'Trang điểm', 615922.13, 74, 'https://example.com/images/dior_sauvage_eau_de_toilette.jpg', N'Sản phẩm Dior Sauvage Eau de Toilette thuộc danh mục Trang điểm, phù hợp với mọi loại da.'),
(N'Innisfree Jeju Orchid Enriched Cream', N'Dưỡng da', 961344.18, 50, 'https://example.com/images/innisfree_jeju_orchid_enriched_cream.jpg', N'Sản phẩm Innisfree Jeju Orchid Enriched Cream thuộc danh mục Dưỡng da, phù hợp với mọi loại da.'),
(N'MAC Retro Matte Lipstick', N'Khác', 337895.16, 47, 'https://example.com/images/mac_retro_matte_lipstick.jpg', N'Sản phẩm MAC Retro Matte Lipstick thuộc danh mục Khác'),
(N'Simple Micellar Cleansing Water', N'Sửa rửa mặt', 437124.6, 87, 'https://example.com/images/simple_micellar_cleansing_water.jpg', N'Sản phẩm Simple Micellar Cleansing Water thuộc danh mục Sửa rửa mặt, phù hợp với mọi loại da.'),
(N'The Ordinary Niacinamide 10% + Zinc 1%', N'Dưỡng tóc', 302401.95, 56, 'https://example.com/images/the_ordinary_niacinamide_10_plus_zinc_1.jpg', N'Sản phẩm The Ordinary Niacinamide 10% + Zinc 1% thuộc danh mục Dưỡng tóc.'),
(N'Neutrogena Hydro Boost Water Gel', N'Nước hoa', 271911.7, 51, 'https://example.com/images/neutrogena_hydro_boost_water_gel.jpg', N'Sản phẩm Neutrogena Hydro Boost Water Gel thuộc danh mục Nước hoa, phù hợp với mọi loại da.'),
(N'Estee Lauder Advanced Night Repair', N'Chống nắng', 987058.66, 19, 'https://example.com/images/estee_lauder_advanced_night_repair.jpg', N'Sản phẩm Estee Lauder Advanced Night Repair thuộc danh mục Chống nắng, phù hợp với mọi loại da.'),
(N'Laneige Lip Sleeping Mask', N'Dưỡng da', 1012931.02, 94, 'https://example.com/images/laneige_lip_sleeping_mask.jpg', N'Sản phẩm Laneige Lip Sleeping Mask thuộc danh mục Dưỡng da, phù hợp với mọi loại da.'),
(N'Clinique Dramatically Different Moisturizing Gel', N'Nước hoa', 749371.29, 45, 'https://example.com/images/clinique_dramatically_different_moisturizing_gel.jpg', N'Sản phẩm Clinique Dramatically Different Moisturizing Gel thuộc danh mục Nước hoa, phù hợp với mọi loại da.'),
(N'Vichy Mineral 89', N'Dưỡng tóc', 940861.91, 61, 'https://example.com/images/vichy_mineral_89.jpg', N'Sản phẩm Vichy Mineral 89 thuộc danh mục Dưỡng tóc.'),
(N'Shiseido Ultimune Power Infusing Concentrate', N'Chống nắng', 1042077.41, 91, 'https://example.com/images/shiseido_ultimune_power_infusing_concentrate.jpg', N'Sản phẩm Shiseido Ultimune Power Infusing Concentrate thuộc danh mục Chống nắng, phù hợp với mọi loại da.'),
(N'NARS Radiant Creamy Concealer', N'Tẩy trang', 390727.85, 85, 'https://example.com/images/nars_radiant_creamy_concealer.jpg', N'Sản phẩm NARS Radiant Creamy Concealer thuộc danh mục Tẩy trang, phù hợp với mọi loại da.'),
(N'The Body Shop Tea Tree Oil', N'Dưỡng da', 742665.75, 95, 'https://example.com/images/the_body_shop_tea_tree_oil.jpg', N'Sản phẩm The Body Shop Tea Tree Oil thuộc danh mục Dưỡng da, phù hợp với mọi loại da.'),
(N'Kiehl''s Calendula Herbal-Extract Toner', N'Trang điểm', 477097.67, 57, 'https://example.com/images/kiehl''s_calendula_herbal-extract_toner.jpg', N'Sản phẩm Kiehl''s Calendula Herbal-Extract Toner thuộc danh mục Trang điểm, phù hợp với mọi loại da.'),
(N'COSRX Advanced Snail 96 Mucin Power Essence', N'Dưỡng tóc', 684423.18, 65, 'https://example.com/images/cosrx_advanced_snail_96_mucin_power_essence.jpg', N'Sản phẩm COSRX Advanced Snail 96 Mucin Power Essence thuộc danh mục Dưỡng tóc.'),
(N'Hada Labo Gokujyun Lotion', N'Sửa rửa mặt', 1135923.11, 32, 'https://example.com/images/hada_labo_gokujyun_lotion.jpg', N'Sản phẩm Hada Labo Gokujyun Lotion thuộc danh mục Sửa rửa mặt, phù hợp với mọi loại da.'),
(N'SK-II Facial Treatment Essence', N'Khác', 428532.97, 58, 'https://example.com/images/sk-ii_facial_treatment_essence.jpg', N'Sản phẩm SK-II Facial Treatment Essence thuộc danh mục Khác.'),
(N'The Face Shop Rice Water Bright Foam Cleanser', N'Dưỡng da', 427265.4, 89, 'https://example.com/images/the_face_shop_rice_water_bright_foam_cleanser.jpg', N'Sản phẩm The Face Shop Rice Water Bright Foam Cleanser thuộc danh mục Dưỡng da, phù hợp với mọi loại da.'),
(N'YSL Rouge Pur Couture Lipstick', N'Khác', 534454.41, 84, 'https://example.com/images/ysl_rouge_pur_couture_lipstick.jpg', N'Sản phẩm YSL Rouge Pur Couture Lipstick thuộc danh mục Khác.'),
(N'Romand Juicy Lasting Tint', N'Tẩy trang', 882304.2, 60, 'https://example.com/images/romand_juicy_lasting_tint.jpg', N'Sản phẩm Romand Juicy Lasting Tint thuộc danh mục Tẩy trang, phù hợp với mọi loại da.'),
(N'Cetaphil Gentle Skin Cleanser', N'Khác', 970087.01, 32, 'https://example.com/images/cetaphil_gentle_skin_cleanser.jpg', N'Sản phẩm Cetaphil Gentle Skin Cleanser thuộc danh mục Khác, phù hợp với mọi loại da.'),
(N'Paula''s Choice BHA Liquid Exfoliant', N'Trang điểm', 561280.95, 18, 'https://example.com/images/paulas_choice_bha_liquid_exfoliant.jpg', N'Sản phẩm Paula''s Choice BHA Liquid Exfoliant thuộc danh mục Trang điểm, phù hợp với mọi loại da.'),
(N'Etude House Drawing Eye Brow', N'Tẩy trang', 329760.65, 16, 'https://example.com/images/etude_house_drawing_eye_brow.jpg', N'Sản phẩm Etude House Drawing Eye Brow thuộc danh mục Tẩy trang, phù hợp với mọi loại da.'),
(N'Eucerin ProACNE Solution Toner', N'Sửa rửa mặt', 557696.32, 48, 'https://example.com/images/eucerin_proacne_solution_toner.jpg', N'Sản phẩm Eucerin ProACNE Solution Toner thuộc danh mục Sửa rửa mặt, phù hợp với mọi loại da.');
